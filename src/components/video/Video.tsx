const Video = () => {
  return (
    <div className="w-full lg:pt-[100px] pt-[75px] bg-[#F0F2F3] flex flex-col justify-center items-center relative gap-[16px] lg:gap-[32px]">
      <h1 className="font-kalameh text-xl font-bold text-center px-[16px]">
