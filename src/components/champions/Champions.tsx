  ...
  return (
    <div className="w-full relative flex flex-col justify-start items-center bg-[#F0F2F3] dark:bg-neutral-800 font-kalameh pt-[80px] lg:px-[76px] px-[16px]">
      ...
      <div className="w-full xl:h-[307px] h-fit flex flex-col-reverse gap-[16px] xl:gap-[0px] xl:flex-row justify-between items-center relative perspective-1000 mt-[40px]">
        <div className="w-[695px] relative h-[307px] hidden md:block">
          ...
          >
            <div className="w-[165px] h-[191px] rounded-2xl bg-gradient-to-b from-[#8D50BE]/10 dark:from-[#8D50BE] to-[#90CAF9]/10 dark:to-[#90CAF9] shadow-md flex flex-col justify-between items-center py-[16px]">
              <p className="text-[#8D50BE] font-bold text dark:text-white">2100</p>
              <Image
                src="/champions/3.png"
                width={112}
                height={103}
        ...
        <div ref={containerRef} className="flex flex-col h-full justify-center items-center gap-[20px] xl:w-[calc(100%-750px)] w-full font-kalameh">
