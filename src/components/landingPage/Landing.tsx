const Landing = () => {
  return (
    <div className="relative w-full h-screen flex flex-col justify-start items-center">
      ...
      />
      <div
        className="absolute w-[25px] aspect-square bg-[#c90f75] rounded-full top-[70%] left-[25%] lg:left-[17%] dot-anim"
        style={{ animationDelay: "1.5s" }}
      />
      <div
        className="absolute w-[30px] aspect-square bg-[#c90f75] rounded-full top-[80%] left-[15%] lg:left-[10%] dot-anim"
        style={{ animationDelay: "1s" }}
      />
      <div
        className="absolute w-[25px] aspect-square bg-[#FEB235] rounded-full top-[44%] left-[63%] lg:left-[25%] dot-anim"
      ...
      <div className="absolute inset-0 h-screen flex flex-col justify-center items-center lg:items-end px-[20px] lg:px-[96px]">
        <div className="w-full flex justify-center lg:justify-end items-center">
          <div className="relative w-[265px] lg:w-[100px] h-[50px] lg:h-[110px] overflow-hidden title-anime xs:title-anime-sm">
            <div className="w-[100px] lg:w-[246px] h-[50px] lg:h-[110px] absolute right-0">
              <h1 className="lg:text-8xl h-full text-4xl font-kalameh font-bold bg-gradient-to-tl from-[#FFD288] via-[#EBDCBB] to-[#D8E6EE] text-transparent bg-clip-text">
                با سِلدا
              </h1>
            </div>
          </div>
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center top-[75%] gap-[20px] h-fit w-full">
        ...
        <button className="w-[182px] h-[68px] bg-white rounded-full font-kalameh text-xl font-bold cursor-pointer text-[#7524B7] hover:bg-[#7524B7] hover:text-white hover:shadow-[0_0_35px_10px_rgba(255,255,255,0.4)] transition-shadow duration-300">
          مشاهده پلن ها
        </button>
      </div>
    </div>
