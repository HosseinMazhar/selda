const Landing = () => {
  return (
    <div className="relative w-full h-screen flex flex-col justify-start items-center">
      ...
      {/* Dots */}
      <div className="absolute w-[15px] aspect-square bg-[#FEB235] rounded-full top-[50%] left-[20%] lg:left-[9%] animate-ping shadow-[0_0_30px_10px_rgba(255,255,0,0.8)]"></div>
      ...
      <div className="absolute w-[10px] aspect-square bg-[#FEB235] rounded-full top-[56%] left-[55%] lg:left-[34%] animate-ping shadow-[0_0_30px_10px_rgba(255,255,0,0.8)]"></div>
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center top-[75%] gap-[20px] h-fit w-full">
        ...
        <button className="w-[182px] h-[68px] bg-white rounded-full border-black border font-kalameh text-xl font-bold cursor-pointer text-[#7524B7]">
          مشاهده پلن ها
        </button>
      </div>
    </div>
