  ...
  return (
    <div className="relative w-full">
      <div className="absolute top-0 left-0 w-screen h-[5px] bg-[#FEB235]/20 overflow-hidden z-40">
        <div className="moving-gradient h-full w-[900px]"></div>
      </div>
      <Swiper
      ...
      <div className="absolute top-[50px] w-full h-fit flex justify-center items-center z-40 font-kalameh text-white font-bold text-xl">
        <p>نمایی از داشبورد های شخصی سازی شده</p>
      </div>
    </div>
  );
};
